...
goog.exportSymbol('proto.dummy.DummyService', null, global);
/**
 ...
 * @constructor
 */
proto.dummy.DummyService = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dummy.DummyService, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.dummy.DummyService.displayName = 'proto.dummy.DummyService';
}
 ...
 * @return {!Object}
 */
proto.dummy.DummyService.prototype.toObject = function(opt_includeInstance) {
  return proto.dummy.DummyService.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dummy.DummyService} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dummy.DummyService.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dummy.DummyService}
 */
proto.dummy.DummyService.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dummy.DummyService;
  return proto.dummy.DummyService.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dummy.DummyService} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dummy.DummyService}
 */
proto.dummy.DummyService.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.dummy.DummyService.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.dummy.DummyService.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.dummy.DummyService} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dummy.DummyService.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
